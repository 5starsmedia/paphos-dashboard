...
exports.controller = function (app, sendOpts, model, next) {
  ...
  model.activateLink = app.config.get('apiUrl') + '/auth/activate/' + model.activationToken;
  model.activateBrokenLink = app.config.get('apiUrl') + '/auth/activate/' + model.brokenToken;
